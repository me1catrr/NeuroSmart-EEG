...
# Etapas del pipeline
include(joinpath(@__DIR__, "..", "Preprocessing", "IO.jl"))
include(joinpath(@__DIR__, "..", "Preprocessing", "filtering.jl"))
include(joinpath(@__DIR__, "..", "Processing", "ICA.jl"))
include(joinpath(@__DIR__, "..", "Processing", "ICA_cleaning.jl"))
...
include(joinpath(@__DIR__, "..", "Processing", "FFT.jl"))
